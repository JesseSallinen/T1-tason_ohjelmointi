...
namespace Kysymystehtava
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            VastausARB.CheckedChanged += new EventHandler(radioButton5_CheckedChanged);
            VastausBRB.CheckedChanged += new EventHandler(radioButton5_CheckedChanged);
            VastausCRB.CheckedChanged += new EventHandler(radioButton5_CheckedChanged);
            VastausDRB.CheckedChanged += new EventHandler(radioButton5_CheckedChanged);
        }
